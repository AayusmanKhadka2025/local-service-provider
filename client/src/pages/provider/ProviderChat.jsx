...
//           </button>
//           <img
//             src={user.avatar || `https://ui-avatars.com/api/?name=${user.name}&background=ffffff&color=3b82f6&size=80`}
...
//             <p className="text-sm text-gray-500 mt-2">Send a message to {user.name} to start the conversation.</p>
//           </div>
//         ) : (
