...
// Ticket Detail Modal for Provider
...
const ProviderHelp = () => {
  ...
  const providerFaqs = [
    {
      id: 1,
      title: "How do I manage my bookings?",
      content: "From your Dashboard:\n1. View pending booking requests under 'Recent Booking Requests'\n2. Accept or reject requests\n3. Once accepted, the booking moves to 'Accepted Bookings'\n4. Start the service when you arrive\n5. Complete the service when finished",
    },
    {
      id: 2,
      title: "How do I update my availability?",
      content: "To update your available days:\n1. Go to Profile Settings\n2. Scroll to 'Available Days'\n3. Select/deselect days you're available\n4. Click 'Save Changes'\nThis helps customers know when to book you.",
    },
    {
      id: 3,
      title: "How is payment calculated and processed?",
      content: "Payment calculation:\n- Based on your hourly rate × actual hours worked\n- Hours are rounded up to the next hour\n- Example: 1.5 hours = charged for 2 hours\n\nPayment processing:\n- Customers pay via eSewa after service completion\n- Funds are transferred to your account\n- You can track earnings in the 'Earnings' section",
    },
    {
      id: 4,
      title: "What should I do if a customer doesn't show up?",
      content: "If a customer doesn't show:\n1. Wait at the location for 15-20 minutes\n2. Try contacting them via chat\n3. If no response, mark the booking as 'No Show' in the app\n4. Contact support for further assistance\n5. You may be eligible for a cancellation fee",
    },
    {
      id: 5,
      title: "How do I get verified?",
      content: "Verification process:\n1. Complete your profile with accurate information\n2. Upload valid government ID\n3. Submit portfolio/work samples\n4. Wait for admin review (24-48 hours)\n5. Once verified, you'll receive a verification badge\n6. You'll be notified via email",
    },
    {
      id: 6,
      title: "How can I improve my visibility?",
      content: "To increase your chances of getting booked:\n1. Keep your profile complete and professional\n2. Upload high-quality portfolio images\n3. Respond to booking requests quickly\n4. Maintain high ratings by providing quality service\n5. Set competitive hourly rates\n6. Keep your availability updated",
    },
    {
      id: 7,
      title: "What if I can't complete a confirmed booking?",
      content: "If you cannot complete a confirmed booking:\n1. Contact the customer immediately via chat\n2. Explain the situation\n3. Contact support for assistance\n4. The booking may need to be reassigned\nNote: Frequent cancellations may affect your rating",
    },
    {
      id: 8,
      title: "How do I report inappropriate customer reviews?",
      content: "To report a review:\n1. Go to your Dashboard\n2. Find the booking in 'Booking History'\n3. Click 'View Details' for that customer\n4. Click 'Report Review'\n5. Select a reason and provide details\n6. Admin will review and take appropriate action",
    },
  ];
  ...
  const fetchSupportRequests = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        "http://localhost:5050/api/support/provider",
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-500 rounded-2xl p-8 text-white">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h2 className="text-2xl font-bold">Provider Help & Support</h2>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
          <div className="p-6 border-b border-gray-100 bg-gray-50/50">
            ...
            <p className="text-sm text-gray-500 mt-1">
              Quick answers to common questions for service providers
            </p>
          </div>
              ...
              <form onSubmit={handleSubmitSupport} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., Payment issue, Customer complaint, Verification delay, etc."
