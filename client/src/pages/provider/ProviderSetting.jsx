...
export default function ProviderSetting({ onProfileUpdate }) {
  ...
  // Change fetchLatestProfile function:
  const fetchLatestProfile = async () => {
    ...
    try {
      ...
      // Changed endpoint to match new route
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-red-500 mt-1 max-w-md">
                Once you deactivate your account, you won't be able to receive
                new bookings. Your profile will be hidden from users.
              </p>
            </div>
          </div>
