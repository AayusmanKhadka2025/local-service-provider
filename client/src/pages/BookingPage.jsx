...
export default function BookingPage() {
  ...
  useEffect(() => {
    if (location.state?.provider) {
      ...
      // If no provider data, redirect back to service listing
  ...
  const handleBooking = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        alert(
          "Booking request sent successfully! The provider will confirm shortly.",
        );
        setTimeout(() => {
          navigate("/dashboard");
        }, 2000);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div
        ref={mainContentRef}
        className="max-w-7xl mx-auto px-6 py-10 grid lg:grid-cols-3 gap-8 scroll-smooth"
      >
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 flex gap-5">
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap items-center gap-4 mt-3 text-sm text-gray-600">
                  <span className="flex items-center gap-1 transition-colors hover:text-blue-600">
            ...
            <div className="p-6 border-t border-gray-100">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                {provider.description ||
                  "Professional service provider with years of experience in the industry. Dedicated to providing quality service and customer satisfaction."}
              </p>
          ...
          {/* REVIEWS SECTION - Placeholder, will be populated from backend later */}
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 transition-all duration-300 hover:shadow-xl">
            ...
            <div className="space-y-4">
              <div className="border border-gray-100 rounded-xl p-4 transition-all duration-300 hover:shadow-md hover:border-blue-100">
                <div className="flex justify-between items-start">
                  <div>
                    <h4 className="font-medium text-gray-800">Sarah Jenkins</h4>
                ...
                <p className="text-sm text-gray-600 mt-2">
                  ...
                  punctual, and did an amazing job. Highly recommended!
                </p>
              </div>
              <div className="border border-gray-100 rounded-xl p-4 transition-all duration-300 hover:shadow-md hover:border-blue-100">
                <div className="flex justify-between items-start">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                ...
                return (
                  <div
                    key={index}
                    className="flex items-start gap-3 p-3 rounded-xl transition-all duration-300 hover:bg-gray-50 hover:scale-105 cursor-pointer"
                  >
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 sticky top-24 transition-all duration-300 hover:shadow-xl">
              ...
              <div className="mb-6">
                    ...
                    return (
                      <button
                        ...
                        className={`
                          ...
                          ${!isCurrentMonth ? "text-gray-300 cursor-not-allowed opacity-50" : "cursor-pointer"}
                          ${isSelectedDate ? "bg-gradient-to-r from-blue-600 to-blue-500 text-white shadow-md scale-105" : ""}
                          ${isTodayDate && !isSelectedDate ? "border-2 border-blue-300 bg-blue-50 text-blue-600" : ""}
                          ${!isSelectedDate && isCurrentMonth ? "hover:bg-gray-100 hover:scale-105 text-gray-700" : ""}
                        `}
                ...
                <div className="flex justify-between gap-2 mt-4 pt-4 border-t border-gray-100">
                  <button
                    ...
                    className="flex-1 py-2 text-sm bg-gray-100 rounded-lg hover:bg-gray-200 transition-all duration-300 hover:scale-105 text-gray-700"
                  >
                    ← Previous Week
                  </button>
                  <button
              ...
              <div className="mb-6 space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-300"
                  />
            ...
            <div className="mb-6">
              ...
              {showManualInput && (
                <div className="mb-3">
                  <input
                    type="time"
                    value={manualTime || selectedTime}
                    onChange={handleManualTimeChange}
                    className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-300 mb-3"
                  />
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-300 resize-none"
              />
            </div>
            ...
            <p className="text-xs text-gray-400 text-center mt-3">
              You won't be charged yet. Payment will be collected after service
              completion.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            <div>
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 bg-gradient-to-br from-blue-600 to-blue-400 rounded-xl flex items-center justify-center shadow-lg transition-transform duration-300 hover:scale-110">
                  <Home className="w-5 h-5 text-white" />
                </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                {["About Us", "How It Works", "Careers", "Blog"].map((item) => (
                  <li key={item}>
                    <button className="hover:text-white transition-all duration-300 flex items-center gap-2 hover:translate-x-1">
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm">
                <li className="flex items-center gap-3 hover:text-white transition-all duration-300 hover:translate-x-1">
              ...
              <div className="flex gap-3 mt-8">
                {[
                  ...
                  return (
                    <button
                      key={index}
                      className="w-10 h-10 bg-gray-800 rounded-xl flex items-center justify-center transition-all duration-300 hover:bg-gray-700 hover:scale-110 group"
      ...
      <button
        onClick={scrollToTop}
        className={`fixed bottom-8 right-8 bg-gradient-to-r from-blue-600 to-blue-500 text-white p-3 rounded-full shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-110 ${
          isScrolling ? "opacity-100 scale-100" : "opacity-0 scale-0"
        }`}
