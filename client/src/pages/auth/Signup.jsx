...
const Signup = () => {
  ...
  const handleGoogleSignUp = () => {
    ...
    // Store a flag to indicate this is a signup attempt
    ...
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
      ...
      <div className="flex items-center justify-center px-6">
        <div className="w-full max-w-md bg-white rounded-xl shadow-lg p-8">
          ...
          {/* Google Signup Button - Improved */}
          <button
            onClick={handleGoogleSignUp}
            disabled={googleLoading}
            className="w-full mt-4 flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed group"
          >
            {googleLoading ? (
              <>
                <svg
